...
/** @var common\models\TreatmentsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Muolajalar';
$this->params['breadcrumbs'][] = 'Muolajalar ro\'yhati';
?>
                                    ...
                                    <div class="treatments-index">
                                        ...
                                        <?= GridView::widget([
                                            ...
                                            'columns' => [
                                                ...
                                                [
                                                    'attribute' => 'appointment', // Note the change here
                                                    'value' => 'appointment.doctor.firstName',
                                                    'label' => 'Shifokor',
                                                    'filter' => Html::activeTextInput($searchModel, 'appointment', ['class' => 'form-control']), // This adds a filter input for the clinic name
                                                ],
                                                'description:ntext',
                                                'cost',
                                                'date',
